...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <a class="navbar-brand" href="index.php"><span style="color:blue;font-family: 'Permanent Marker', cursive;">ABHISHEK Food Hunt(H.P)</span></a>
    <?php
	if(!empty($cust_id))
	{
	?>
      ...
      <ul class="navbar-nav ml-auto">
		...
		<li class="nav-item">
          ...
          <?php
			...
			{
			?>
			<a href="form/index.php?msg=you must be login first"><span style="color:orange; font-size:30px;"><i class="fa fa-shopping-cart" aria-hidden="true"><span style="color:orange;" id="cart"  class="badge badge-light">0</span></i></span></a>
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/12.jpg" alt="Los Angeles" class="d-block w-100">
    ...
    <div class="carousel-item">
      <img src="img/15.jpg" alt="Chicago" class="d-block w-100">
      <div class="carousel-caption">
        <h3>Welcome to SHIMLA</h3>
        <p>Thank you, VISIT AGAIN!</p>
      </div>   
    </div>
    <div class="carousel-item">
      <img src="img/14.jpg" alt="New York" class="d-block w-100">
      <div class="carousel-caption">
        <h3>DHARAMSHALA</h3>
        <p>We love Cofee(ABHISHEK Food Hunt)</p>
      </div>   
    </div>
  </div>
